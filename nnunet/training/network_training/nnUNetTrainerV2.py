...
class nnUNetTrainerV2(nnUNetTrainer):
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.lambda_kd = 1e-3
        self.T = 4.0
        tz_pids_file = r"D:\dzha937\data_original\PICAI_DataRepo\nnUNet_raw_data_backup\Task1453_picai_baseline\zone_division\Task128_TZOnly_pids.txt"
        ...
        pz_pids_file = r"D:\dzha937\data_original\PICAI_DataRepo\nnUNet_raw_data_backup\Task1453_picai_baseline\zone_division\Task194_BCasPZOnly_pids.txt"
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            splits_file = join(self.dataset_directory, "splits_final_Combined_ThreeGroups_5fold.pkl")
